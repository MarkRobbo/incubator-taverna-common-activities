...
inputs:
  - id: input_1
    ...
    doc: this is a short description of input 1
  ...
  - id: input_2
    ...
    doc: this is a short description of input 2
    format: $expression

  - id: input_3
    type: String
    label: input 3 testing label
    doc: this is a short description of input 3
...
outputs:
  - id: output_1
    ...
    doc: this is a short description of output 1
    format: just a string

  - id: output_2
    type: String
    label: output 2 testing label
    doc: this is a short description of output 2
